...
Finally, we also plot the residuals distribution and the prediction paths for all 4 methods above.
...
For the last method(no correction), it is clear that our predictions are fluctuating a lot because of the randomnes( the weights are not used here).
